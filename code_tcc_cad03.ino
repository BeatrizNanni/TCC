 ...
 * Codigo tcc Cad03
 * Data: 18/11/2023
 * Autoria: Beatriz Nanni, Flavia Kagamida, Bruno Nakao, Kevin Wu
 */
//-----BIBLIOTECAS------//
...
//////////////////////////LEITURA DOS SENSORES/////////////////////////////////// 
   TEMPERATURA();
   PH();
   holdingRegs[VOL_VAL] = (volume_sensor1+volume_sensor2)*100;
...
/////////////////////////////BOMBEAR LIQUIDOS////////////////////////////////
   if ((holdingRegs[MIX] == 1) && (F_ON == 1) && (F_OFF == 0) && (!timerRunning1) && (condicao == 0) && (acabou == 0)){ 
   ...
   if (timerRunning1) {
    ...
    if ((holdingRegs[MIX] == 1) && (F_ON == 1) && (F_OFF == 0) && (!timerRunning2) && (condicao == 1)){
   ...
   if ((holdingRegs[MIX] == 0) && (F_ON == 1) && (F_OFF == 0)){
    ...
    condicao = 0;
    acabou = 0;
    holdingRegs[VAZAO2] = 0;
    holdingRegs[VAZAO1] = 0;
   }
//////////////////////////LIGAR MOTOR///////////////////////////////////
...
////////////////////////FUNCAO VAZAO/////////////////////////////////////
  ...
  if ((timevazao1 - tempo_antes) > 1000) {
    ...
    fluxo = ((1000.0 / (timevazao1 - tempo_antes)) * contador) / 20;
